...
function Dashboard() {
  return <><PageHeader eyebrow="Panel general" title="Resumen de cartera" description="Una vista clara de las evaluaciones, el riesgo y el comportamiento reciente del portafolio." action={<Button asChild><Link to="/evaluaciones">Nueva evaluación<ArrowRight className="size-4" /></Link></Button>} />
